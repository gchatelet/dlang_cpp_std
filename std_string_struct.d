...
extern(C++, std) {
  ...
  struct basic_string(T, TRAITS = char_traits!T, ALLOC = allocator!T) {
    ...
    pragma(mangle, "_ZNKSs4findERKSsm") size_t find(ref const basic_string str, size_t pos = 0) nothrow const;
    ...
    pragma(mangle, "_ZNKSs5rfindERKSsm") size_t rfind(ref const basic_string str, size_t pos = npos) nothrow const;
    ...
    pragma(mangle, "_ZNKSs13find_first_ofERKSsm") size_t find_first_of(ref const basic_string str, size_t pos = 0) nothrow const;
    ...
    pragma(mangle, "_ZNKSs12find_last_ofERKSsm") size_t find_last_of(ref const basic_string str, size_t pos = npos) nothrow const;
    ...
    pragma(mangle, "_ZNKSs17find_first_not_ofERKSsm") size_t find_first_not_of(ref const basic_string str, size_t pos = 0) nothrow const;
    ...
    pragma(mangle, "_ZNKSs16find_last_not_ofERKSsm") size_t find_last_not_of(ref const basic_string str, size_t pos = npos) nothrow const;
    ...
    pragma(mangle, "_ZNKSs7compareERKSs") int compare(ref const basic_string str) nothrow const;
