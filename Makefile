...
cpp_std_struct: instantiated.o cpp_std.d raii.d std_string_struct.d std_allocator.d std_vector.d
	~/dlang/dmd/src/dmd -version=use_structs -g -of$@ $^ -L/lib/libstdc++.a
.PHONY: cpp_std_struct

cpp_std_class: instantiated.o cpp_std.d raii.d std_string_class.d std_allocator.d std_vector.d
	~/dlang/dmd/src/dmd -version=use_classes -g -of$@ $^ -L/lib/libstdc++.a
.PHONY: cpp_std_class

clean:
	rm -f *.o cpp_std_struct cpp_std_class cpp_std