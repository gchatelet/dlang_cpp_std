...
extern(C++, std) {
  ...
  class basic_string(T, TRAITS = char_traits!T, ALLOC = allocator!T) {
    ...
    pragma(mangle, "_ZNKSs4findERKSsm") size_t find(const basic_string str, size_t pos = 0) const;
    ...
    pragma(mangle, "_ZNKSs5rfindERKSsm") size_t rfind(const basic_string str, size_t pos = npos) const;
    ...
    pragma(mangle, "_ZNKSs13find_first_ofERKSsm") size_t find_first_of(const basic_string str, size_t pos = 0) const;
    ...
    pragma(mangle, "_ZNKSs12find_last_ofERKSsm") size_t find_last_of(const basic_string str, size_t pos = npos) const;
    ...
    pragma(mangle, "_ZNKSs17find_first_not_ofERKSsm") size_t find_first_not_of(const basic_string str, size_t pos = 0) const;
    ...
    pragma(mangle, "_ZNKSs16find_last_not_ofERKSsm") size_t find_last_not_of(const basic_string str, size_t pos = npos) const;
    ...
    pragma(mangle, "_ZNKSs7compareERKSs") int compare(const basic_string str) const;
...
unittest {
  auto string_from_d = new std_string("string_from_d\0overun");
  assert(string_from_d.asArray == "string_from_d");

  auto string_copy_from_d = new std_string(string_from_d);
...
unittest {
  std_string s = new std_string("");
  assert(s.size() == 0);
}

unittest { // Modifiers append
  const constant = new std_string("abc");
  auto s = new std_string("");
...
unittest { // Modifiers insert
  const abc = new std_string("abc");
  const def = new std_string("def");
  auto s = new std_string(abc);
